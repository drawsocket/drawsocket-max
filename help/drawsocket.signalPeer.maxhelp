...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 421.0, 57.0, 20.0 ],
					"text" : " /loco"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.064453125, 421.0, 57.0, 20.0 ],
					"text" : " /barbara"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 578.564453125, 212.0, 128.0, 20.0 ],
					"text" : "<< send to /barbara"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 878.564453125, 343.0, 128.0, 20.0 ],
					"text" : "<< send to /loco"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 760.564453125, 257.0, 128.0, 60.0 ],
					"text" : "(now also works without serialization, but needs to be a dictionary)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 910.0, 68.0, 216.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 910.0, 33.0, 221.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 695.83331298828125, 64.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 549.0, 795.66668701171875, 407.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 489.0, 760.0, 79.0, 24.0 ],
					"text" : "drawsocket"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 723.83331298828125, 63.0, 22.0 ],
					"text" : "script stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.435546875, 299.0, 161.0, 118.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.064453125, 292.0, 165.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.064453125, 376.0, 129.0, 22.0 ],
					"text" : "drawsocket.signalPeer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 903.0, 284.0, 37.0, 22.0 ],
					"text" : "o.dict"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.5, 536.0, 299.0, 85.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 716.064453125, 265.0, 37.0, 22.0 ],
					"text" : "o.dict"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 716.064453125, 107.0, 165.0, 136.0 ],
